...
#define INFO0(function, fmt)         logging_log(LOGGING_LEVEL_INFO, function, __FILE__, __LINE__, fmt)
#define WARNING(function, fmt, ...)  logging_log(LOGGING_LEVEL_WARNING, function, __FILE__, __LINE__, fmt, __VA_ARGS__)
#define WARNING0(function, fmt)      logging_log(LOGGING_LEVEL_WARNING, function, __FILE__, __LINE__, fmt)
#define ERROR(function, fmt, ...)    logging_log(LOGGING_LEVEL_ERROR, function, __FILE__, __LINE__, fmt, __VA_ARGS__)
#define ERROR0(function, fmt)        logging_log(LOGGING_LEVEL_ERROR, function, __FILE__, __LINE__, fmt)
